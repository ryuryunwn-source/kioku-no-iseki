...
namespace KiokuNoIseki
{
    ...
    // 効果アーキタイプ。技・魔法の効果はすべてこのIDで表現する（15-4のデフォルト対象を採用）
    ...
    public class RecallerState
    {
        ...
        // ターン状態フラグ
        public bool inscribedThisTurn;      // このターン生贄した→次の減衰スキップ
        public bool skipNextDecay;          // 直前ターンに生贄した→今ターンの減衰スキップ
